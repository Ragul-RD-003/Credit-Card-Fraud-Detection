  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/Ragul-RD-003/Credit-Card-Fraud-Detection/blob/main/NM%20Project.ipynb\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      ...
      "metadata": {
        ...
        "id": "37QWIN_Y1hV7",
        "outputId": "c4093bc4-60b9-4e58-c729-57ca9483e2af"
      },
      "outputs": [
        {
          "output_type": "stream",
          ...
          "text": [
            ...
            "0 -0.379791 -1.249115 -0.241888 -0.376275  0.448177      0  \n",
            "1  1.668149 -0.814947  3.588981 -0.110450 -0.236959      0  \n",
            "2  1.536671  0.350126  2.385810 -1.261293 -0.401290      0  \n",
            "3 -1.529367 -0.098911 -0.770011  1.508547  0.981917      0  \n",
            "4  0.541713 -0.717470  2.582619 -1.898714  0.392731      0  \n",
            "\n",
            "[5 rows x 31 columns]\n",
            "\n",
            "Data types:\n",
            ...
            "Accuracy: 0.98\n",
            "\n",
            "Sample Transaction Prediction:  Legit\n",
            "\n",
